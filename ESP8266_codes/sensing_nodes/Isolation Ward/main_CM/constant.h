...
#define CSE_PORT    8383
#define HTTPS     true
#define FINGER_PRINT  "10 3D D5 4E B1 47 DB 4B 5C B0 89 08 41 A7 A4 14 87 10 7F E8"
#define OM2M_ORGIN    "efgh:efgh"
#define OM2M_MN       "/~/in-cse/isolation_ward/"      // as per resourse treee structure
#define OM2M_AE       "AE_CM/Floor_1"          //change the Floor according to your requirement
